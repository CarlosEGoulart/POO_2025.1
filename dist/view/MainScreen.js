...
class MainScreen {
    constructor(mainController) {
        ...
        this.artistView = new ArtistView_1.default(this.mainController.artistController);
        this.artView = new ArtView_1.default(this.mainController.artController);
        this.exhibitionView = new ExhibitionView_1.default(this.mainController.exhibitionController);
    }
    start() {
        while (true) {
            console.log("\n--- Menu Principal ---");
