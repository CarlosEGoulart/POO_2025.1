...
test("Test Art read", async () => {
    const art = new Art_1.default("Titulo da obra", "Descrição da obra", 2025);
...
test("Test Artist read", async () => {
    const artist = new Artist_1.default("Nome do artista", "Biografia do artista", 2004, "@instagram");
...
test("Test Exhibition read", async () => {
    const exhibition = new Exhibition_1.default("Nome da Exibição", "Descrição da exibição", [1, 2]);
